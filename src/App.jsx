...
function App() {
  ...
  function startWorkDay() {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (position) => {
        ...
        alert("Work day started. Keep this app open for mileage tracking.");
  ...
  function endWorkDay() {
    ...
    const commission = todaySales.reduce(

      (sum, sale) => sum + sale.commissionEarned,

      0

    );

    const expenses = todayReceipts.reduce(
      ...
      <>
        ...
        <section className="hero">
          ...
          <p className="subtitle">
            ...
            Track commissions, mileage, receipts, taxes, and daily analytics from
        ...
        <div className="panel work-card">
          ...
          <p className="notice">
            ...
            {workActive
              ...
              ? `Tracking route while this app stays open. Current mileage: ${currentRouteMiles.toFixed(

                  2

                )} miles.`

              : "Start your work day to enable location tracking and mileage calculation."}
          ...
          <div className="button-row">
            ...
            {!workActive ? (
              ...
              <Button onClick={endWorkDay} variant="danger">
            ...
            <Button onClick={() => setTab("Receipts")} variant="secondary">

              Snap Receipt

            </Button>

            <Button onClick={() => setTab("Sales")} variant="secondary">
      ...
      <>
        ...
        <div className="grid two">
          ...
          <Card
            ...
            title="Business Miles This Year"

            value={`${totals.businessMiles.toFixed(2)} mi`}

          />

          <Card

            title="Mileage Deduction Estimate"

            value={money(totals.mileageDeduction)}
          ...
          <Card
            ...
            value={money(totals.taxes.totalTax)}

            subtitle="Estimate only, not professional tax advice."
      ...
      <>
        ...
        <div className="grid two">
          ...
          <Card
            ...
            title="Current Work Day Mileage"

            value={`${currentRouteMiles.toFixed(2)} mi`}

            subtitle={workActive ? "Live while app is open" : "Start a work day to track route"}

          />

          <Card

            title="Year Mileage Deduction"

            value={money(totals.mileageDeduction)}

            subtitle={`${totals.businessMiles.toFixed(2)} miles × ${money(
      ...
      <>
        ...
        <div className="panel">
          ...
          {receiptForm.image ? (
            ...
            <img className="receipt-img" src={receiptForm.image} alt="Receipt preview" />
          ...
          {data.receipts.map((receipt) => (
            ...
            <div className="list-item" key={receipt.id}>
              ...
              {receipt.image ? (
                ...
                <img className="receipt-img" src={receipt.image} alt="Receipt" />
      ...
      <>
        ...
        <div className="grid two">
          ...
          <Card
            ...
            value={money(totals.taxes.quarterlyPayment)}
        ...
        <p className="notice">
          ...
          This is only an estimate and is not professional tax advice.
      ...
      <>
        ...
        <div className="panel">
          ...
          <div className="button-row">
            ...
            <Button onClick={resetDemoData} variant="danger">
